...
const ACTIVITY_DATA: Record<string, { bilde: string; desc: string }> = {
  ...
  'Finsequiz':                              { bilde: '/assets/images/tog.png', desc: 'Hele året. Kveldsunderholdning foran peisen inne på hotellet. Kategoriene tilpasses, men vi sniker alltid med noen spørsmål om natur og Finse-historie.' },
